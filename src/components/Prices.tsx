...
const servicePackages = [
  ...
  {
    title: "Диджитал-Премиум",
    price: "40000 сом / мес",
    features: [
      "Интернет-магазин до 1000 товаров",
      "Разработка мобильного приложения (MVP)",
      "Создание фирменного стиля и графического дизайна",
  ...
  },
  {
    ...
    price: "65000 сом / мес",
    features: [
      "Разработка портала / ERP-системы под ключ",
      "Мобильное приложение (iOS/Android)",
      "Полный брендинг и графический дизайн",
